...
#define MPP_SIZE                    (1<<MPP_SIZE_SHIFT)//2048

#define PAGE_PER_PHY_BLOCK          (1<<PAGE_PER_BLOCK_SHIFT)//64
...
#define TOTAL_DIE_COUNT             (1<<TOTAL_DIE_SHIFT)//1
...
#define CFG_LOG_BLOCK_COUNT_SHIFT   (BLOCK_PER_PLANE_SHIFT + \
                                     DIE_PER_CHIP_SHIFT + \
                                     CHIP_COUNT_SHIFT)//12
#define CFG_PHY_BLOCK_COUNT         (1<<CFG_PHY_BLOCK_COUNT_SHIFT)//4096
#define CFG_LOG_BLOCK_COUNT         (1<<CFG_LOG_BLOCK_COUNT_SHIFT)//4096
...
#define CFG_PHY_BLOCK_PER_AREA      (MPP_SIZE/2/sizeof(PHY_BLOCK))//256

#define AREA_COUNT                  ((CFG_LOG_BLOCK_COUNT +       \
                                      CFG_PHY_BLOCK_PER_AREA -    \
                                      1) /                        \
                                     CFG_PHY_BLOCK_PER_AREA)//16
#define AREA_TABLE_SIZE             (MPP_SIZE/2/2/sizeof(PHY_BLOCK))//128
