...
static sgx_status_t SGX_CDECL Enclave_ocall_printint(void* pms)
{
	ms_ocall_printint_t* ms = SGX_CAST(ms_ocall_printint_t*, pms);
	ocall_printint(ms->ms_buffer);
